...
import type { Tool } from "./tools/page";
import type { Component } from "./components/page";
import type { GalleryItem } from "./gallery/page";
        ...
        <section id="hero" className="px-10 py-14 bg-secondary">
          <div className="">
            ...
            <h1 className="text-6xl md:text-7xl font-bold mt-4 text-white md:leading-20">
              AICTE <br className="md:hidden" />
              <span className="text-primary-v2">IDEA LAB</span>
            </h1>
            ...
            <p className="text-white/90 text-normal md:text-lg mt-4 md:mt-6">
              A hub for innovation, creativity and hands-on-learning, <br />
            ...
            <div className="grid grid-cols-2 md:flex flex-row gap-4 items-center mt-6">
              ...
              <Link
                href="/tools"
                className="rounded-xl focus-within:ring-primary ring-0 focus-within:ring-offset-2 transition-all font-medium shadow-sm px-4 py-2 border border-neutral-500 text-white"
              >
                View Tools
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 items-center mt-10">
            <div className="flex flex-row gap-3 items-center">
              ...
              <div>
                <p className="text-neutral-50">Learn by Doing</p>
            ...
            <div className="flex flex-row gap-3 items-center">
              ...
              <div>
                <p className="text-neutral-50">Innovate</p>
                <p className="text-sm md:text-base text-neutral-300">
                  Think. Design, Build
                </p>
              </div>
            ...
            <div className="flex flex-row gap-3 items-center">
              ...
              <div>
                <p className="text-neutral-50">Collaborate</p>
                <p className="text-sm md:text-base text-neutral-300">
                  Work together
                </p>
              </div>
            ...
            <div className="flex flex-row gap-3 items-center">
              ...
              <div>
                <p className="text-neutral-50">Excel</p>
                <p className="text-sm md:text-base text-neutral-300">
                  Create impact
                </p>
              </div>
        ...
        <section id="about" className="px-10 py-14">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <h2 className="text-3xl font-bold mt-3">
                What is <span className="text-primary">AICTE IDEA Lab?</span>
              </h2>
              ...
              <ul className="mt-6 flex text-secondary flex-col gap-2 [&>li]:flex [&>li]:flex-row [&>li]:gap-2 [&>li]:items-center [&>li>i]:text-sm [&>li>i]:rounded-full [&>li>i]:bg-primary [&>li>i]:p-1 [&>li>i]:text-white">
                <li>
                  ...
                  <p>Enhances creativity, imagination & innovation</p>
                </li>
                <li>
                  <i className="ph-bold ph-check" />
                  <p>Promotes 21st century skills</p>
                </li>
                <li>
                  <i className="ph-bold ph-check" />
                  <p>Encourages interdisciplinary learning</p>
                </li>
                <li>
                  <i className="ph-bold ph-check" />
                  <p>Transforms ideas into prototypes</p>
                </li>
                <li>
                  <i className="ph-bold ph-check" />
                  <p>Supports students & faculty projects</p>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-base font-medium mt-3 max-w-sm">
                To provide all facilities under one roof for conversion of an
                idea into a prototype and to nurture innovative minds through
                training, exposure and support.
              </p>
              ...
              <div className="flex flex-row items-center gap-2 mt-4">
                ...
                <div>
                  <i className="ph ph-arrow-right md:text-xl"></i>
                </div>
                <div className="flex flex-col gap-2 items-center justify-center">
          ...
          <div className="px-6 md:px-10 py-6 md:py-8 rounded-xl bg-secondary mt-10">
            <h3 className="text-indigo-50 text-sm md:text-base font-bold uppercase inline-flex items-center">
              <span className="text-indigo-200">IDEA LAB CET</span>
              <i className="ph ph-dot text-xl"></i> at a glance
            </h3>
        ...
        >
          <div>
            <div className="flex flex-row items-center justify-between gap-4">
              ...
              <a
                href="/components"
                className="inline-flex items-center gap-1 text-primary whitespace-nowrap focus-within:underline"
              >
                View All Components
      ...
      <GallaryGrid galleryItems={galleryItems} />
        ...
        <section id="ready" className="px-10 pb-8">
          <div className="px-6 md:px-6 py-6 md:py-8 bg-secondary rounded-xl flex flex-col md:flex-row md:items-center justify-between">
            ...
            <button className="focus-within:ring-primary ring-0 focus-within:ring-offset-2 mt-6 md:mt-0 rounded-xl shadow-sm border border-primary/70 px-4 py-2 bg-primary text-white font-semibold">
              Contact Us
            </button>
          </div>
        </section>
