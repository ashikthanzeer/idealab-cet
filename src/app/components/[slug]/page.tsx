...
export default async function ComponentDetailPage({ params }: Props) {
  ...
  const component = await client.fetch<Component | null>(
            ...
            <section className="px-10 pb-14">
              <div className="mx-auto max-w-7xl">
                ...
                <div className="mt-5 overflow-hidden rounded-lg border border-neutral-300 bg-white">
                  {component.specifications.map((specification, index) => (
                    <div
          ...
          <section className="px-10 pb-14">
            <div className="mx-auto max-w-7xl">
              ...
              <div className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {component.gallery.map((image, index) => (
                  <div
                    key={index}
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 font-medium text-neutral-300">
                  Browse the complete IDEA Lab components catalogue.
                </p>
              </div>
